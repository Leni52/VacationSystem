...
namespace WorkForceManagement.DAL.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TeamId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TimeOffRequestId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Approvals_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Approvals_TimeOffRequests_TimeOffRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Approvals_TeamId",
                table: "Approvals",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_Approvals_TimeOffRequestId",
                table: "Approvals",
